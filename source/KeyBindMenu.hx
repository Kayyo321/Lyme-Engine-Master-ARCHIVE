...
class KeyBindMenu extends FlxSubState
{
	...
	{	
		...
		infoText.borderQuality = 4;
        infoText.alpha = 0;
        infoText.screenCenter(FlxAxes.X);
        add(infoText);
        add(keyTextDisplay);

        kindaCringBro = new FlxText(-10, 630, 1280, "All Credit Goes to KadeDev and RozeBud for this keybind menu god bless ;)", 48);
        kindaCringBro.scrollFactor.set(0, 0);
        kindaCringBro.setFormat("VCR OSD Mono", 24, FlxColor.WHITE, FlxTextAlign.CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
        kindaCringBro.borderSize = 2;
        kindaCringBro.borderQuality = 4;
	...
	override function update(elapsed:Float)
	{
        ...
        // FlxG.sound.playMusic(Paths.music('Stupid'));
    ...
    function quit(){
        ...
        FlxTween.tween(kindaCringBro, {alpha: 0}, 1, {ease: FlxEase.expoInOut});
    }
